function ToggleFullScreen() {
		...
		var buildUrl = "Build";
		var loaderUrl = buildUrl + "/Street_Fighter.loader.js";
		var config = {
        dataUrl: buildUrl + "/Street_Fighter.data",
        frameworkUrl: buildUrl + "/Street_Fighter.framework.js",
        codeUrl: buildUrl + "/Street_Fighter.wasm",
        streamingAssetsUrl: "StreamingAssets",
        companyName: "Gamebol",
        productName: "Street Fighter",
        productVersion: "1.0",
      };
