...
function addBtnHome() {
  ...
  if (referrer.indexOf("https://6xgamez54z5zs.com/") !== -1) {
    ...
    e.innerHTML = `
      ...
      <img src="https://ubggames.com/library/ubggames.png" width="140px" height="45px" alt="Pizza Edition Games">`;
    ...
    e.innerHTML = `
      ...
      <img src="https://ubggames.com/library//ubggames.png" width="13px" height="36px" alt="Pizza Edition Games">`;
...
function returnHome(){
    ...
    var newWindow = window.open("https://ubggames.com", "_blank");

    newWindow.document.title = "UbgGames.com";

}

function opendiscord(){

    window.open("https://ubggames.com");
