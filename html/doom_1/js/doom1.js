...
(function () {
  var loadPackage = function (metadata) {
    ...
    var REMOTE_PACKAGE_BASE = "doom1.wad";
  ...
  loadPackage({
    files: [{ start: 0, audio: 0, end: 11159840, filename: "/DOOM.WAD" }],
    remote_package_size: 11159840,
    package_uuid: "abdc4c08-b5ec-43d7-a035-7dada7df2435",
  });
})();
...
function abortFnPtrError(ptr, sig) {
  ...
  for (var x in debug_tables) {
    ...
    if (tbl[ptr]) {
      possibleSig +=
        'as sig "' + x + '" pointing to function ' + tbl[ptr] + ", ";
    }
  }
  abort(
    "Invalid function pointer " +
      ...
      sig +
      "'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this). This pointer might make sense in another type signature: " +
      possibleSig
  );
}
...
function __findCanvasEventTarget(target) {
  ...
  if (!target || target === "#canvas") {
    if (typeof GL !== "undefined" && GL.offscreenCanvases["canvas"])
      return GL.offscreenCanvases["canvas"]; // TODO: Remove this line, target '#canvas' should refer only to Module['canvas'], not to GL.offscreenCanvases['canvas'] - but need stricter tests to be able to remove this line.
...
function __fillMouseEventData(eventStruct, e, target) {
  ...
  if (target) {
    ...
    // No specific target passed, return 0.
...
var debug_table_i = [
  0,
  "_I_OPL_InitMusic",
  "_I_OPL_MusicIsPlaying",
  "_I_WEB_InitMusic",
  "_I_WEB_MusicIsPlaying",
  "_Emscripten_Available",
  "_EMSCRIPTEN_JoystickInit",
  "_EMSCRIPTEN_JoystickGetCount",
  "_D_GrabMouseCallback",
  "_eglWaitGL",
  "_eglGetError",
...
var debug_table_ii = [
  ...
  "_OPL_SDL_PortRead",
  "_I_SDL_InitSound",
  "_I_SDL_GetSfxLumpNum",
  "_I_SDL_SoundIsPlaying",
  "_W_StdC_OpenFile",
  "_malloc",
  "_getpix_8",
  "_getpix_16",
  ...
  "_DISKAUDIO_Init",
  "_DUMMYAUDIO_Init",
  "_EMSCRIPTEN_JoystickGetDeviceName",
  "_EMSCRIPTEN_JoystickGetDevicePlayerIndex",
  "_EMSCRIPTEN_JoystickGetDeviceInstanceID",
  "___stdio_close",
  "_PIT_VileCheck",
  "_PIT_StompThing",
  "_PIT_CheckThing",
  ...
  "_PIT_RadiusAttack",
  "_PIT_ChangeSector",
  "_PIT_AddLineIntercepts",
  "_PIT_AddThingIntercepts",
  "_EV_DoGenFloor",
  "_EV_DoGenCeiling",
  "_EV_DoGenDoor",
  "_EV_DoGenLockedDoor",
  ...
  "_EV_DoGenStairs",
  "_EV_DoGenCrusher",
  "_R_BrightmapForTexName_Hacx",
  "_R_BrightmapForSprite_Hacx",
  "_R_BrightmapForFlatNum_Hacx",
  "_R_BrightmapForState_Hacx",
  "_R_BrightmapForTexName_Chex",
  "_R_BrightmapForSprite_Chex",
  "_R_BrightmapForFlatNum_None",
  "_R_BrightmapForState_None",
  "_R_BrightmapForTexName_Doom",
  "_R_BrightmapForSprite_Doom",
  "_R_BrightmapForFlatNum_Doom",
  "_R_BrightmapForState_Doom",
  ...
  "_Emscripten_CreateSystemCursor",
...
var debug_table_iii = [
  0,
  "_OPL3_EnvelopeCalcSin0",
  "_OPL3_EnvelopeCalcSin1",
  "_OPL3_EnvelopeCalcSin2",
  "_OPL3_EnvelopeCalcSin3",
  "_OPL3_EnvelopeCalcSin4",
  "_OPL3_EnvelopeCalcSin5",
  "_OPL3_EnvelopeCalcSin6",
  "_OPL3_EnvelopeCalcSin7",
  "_DEH_TextStart",
  "_DEH_AmmoStart",
  "_DEH_BEXInclStart",
  "_DEH_BEXParsStart",
  ...
  "_drawpatchpx10",
  "_drawpatchpx11",
  "_GLES2_SupportsBlendMode",
  "_GLES2_CreateTexture",
  "_GLES2_SetRenderTarget",
  "_GLES2_UnbindTexture",
  "_RemovePendingSizeChangedAndResizedEvents",
  "_RemovePendingMoveEvents",
  "_RemovePendingExposedEvents",
  "_cmpmodes",
  "_SW_CreateTexture",
  "_SW_SetTextureColorMod",
...
var debug_table_iiii = [
  0,
  "_wipe_initColorXForm",
  "_wipe_doColorXForm",
  "_wipe_exitColorXForm",
  "_wipe_initMelt",
  "_wipe_doMelt",
  "_wipe_exitMelt",
  "___stdout_write",
...
var debug_table_v = [
  ...
  "_M_DrawNewGame",
  "_M_DrawEpisode",
  "_I_OPL_ShutdownMusic",
  "_I_OPL_PauseSong",
  "_I_OPL_ResumeSong",
  "_I_OPL_StopSong",
  "_I_SDL_ShutdownSound",
  "_I_SDL_UpdateSound",
  "_I_WEB_ShutdownMusic",
  "_I_WEB_PauseSong",
  "_I_WEB_ResumeSong",
  "_I_WEB_StopSong",
  "_EMSCRIPTEN_JoystickDetect",
  "_EMSCRIPTEN_JoystickQuit",
  "_D_DoomLoopIter",
  "_D_CancelLoopIter",
  "_D_Endoom",
  "_M_SaveDefaults",
  "_G_CheckDemoStatusAtExit",
  "_StatDump",
  "_M_DrawReadThisCommercial",
  "_R_DrawColumn",
  "_R_DrawColumnLow",
  "_R_DrawFuzzColumn",
...
var debug_table_vi = [
  ...
  "_M_ChangeDetail",
  "_M_SizeDisplay",
  "_M_ChangeSensitivity",
  "_M_Sound",
  "_M_SfxVol",
  "_M_MusicVol",
  "_M_Episode",
  "_M_ChooseSkill",
  "_I_OPL_SetMusicVolume",
  "_I_OPL_UnRegisterSong",
  "_I_SDL_StopSound",
  "_I_WEB_SetMusicVolume",
  "_I_WEB_UnRegisterSong",
  "_W_StdC_CloseFile",
  "_free",
  "_SDL_Blit_RGB888_RGB888_Scale",
  "_SDL_Blit_RGB888_RGB888_Blend",
  "_SDL_Blit_RGB888_RGB888_Blend_Scale",
  "_SDL_Blit_RGB888_RGB888_Modulate",
  ...
  "_SDL_Blit_ABGR8888_RGB888_Modulate_Blend",
  ...
  "_SDL_Blit_BGRA8888_ARGB8888_Scale",
  ...
  "_EMSCRIPTEN_JoystickClose",
  "_OPL_DetectCallback1",
  "_OPL_DetectCallback2",
  "_M_QuitResponse",
  "_M_EndGameResponse",
  "_M_VerifyNightmare",
  "_M_QuickSaveResponse",
  "_M_QuickLoadResponse",
  "_T_MoveCeiling",
  "_T_VerticalDoor",
  "_T_PlatRaise",
  "_P_MobjThinker",
  ...
  "_SDL_AudioThreadDeinit_Default",
  "_SDL_AudioBeginLoopIteration_Default",
  ...
  "_SDL_ResetAudioStreamResampler",
  "_SDL_CleanupAudioStreamResampler",
  "_png_default_flush",
...
var debug_table_vii = [
  ...
  "_A_FireBFG",
  "_I_OPL_PlaySong",
  "_I_SDL_PrecacheSounds",
  "_I_WEB_PlaySong",
  "_EMSCRIPTEN_JoystickGetDeviceGUID",
  "__Eff_PositionDone",
  "_ST_loadCallback",
  "_WI_unloadCallback",
  "_WI_loadCallback",
  ...
  "_SDL_Convert_Byteswap",
  "_SDL_ConvertMonoToStereo",
  "_SDL_ConvertStereoTo51",
  "_SDL_ConvertQuadTo51",
  "_SDL_Convert51To71",
  "_SDL_ConvertStereoToQuad",
  "_SDL_Convert71To51",
  "_SDL_Convert51ToStereo",
  "_SDL_Convert51ToQuad",
  "_SDL_ConvertQuadToStereo",
  "_SDL_ConvertStereoToMono",
  "_SDL_ResampleCVT_c1",
  "_SDL_ResampleCVT_c2",
  "_SDL_ResampleCVT_c4",
  "_SDL_ResampleCVT_c6",
  "_SDL_ResampleCVT_c8",
  "_SDL_Convert_S8_to_F32_Scalar",
  "_SDL_Convert_U8_to_F32_Scalar",
  "_SDL_Convert_S16_to_F32_Scalar",
  "_SDL_Convert_U16_to_F32_Scalar",
  "_SDL_Convert_S32_to_F32_Scalar",
  "_SDL_Convert_F32_to_S8_Scalar",
  "_SDL_Convert_F32_to_U8_Scalar",
  "_SDL_Convert_F32_to_S16_Scalar",
  "_SDL_Convert_F32_to_U16_Scalar",
  "_SDL_Convert_F32_to_S32_Scalar",
  "_emscripten_longjmp",
  "_png_zfree",
  "_png_free",
  "_zcfree",
...
var debug_table_viii = [
  ...
  "_DEH_TextParseLine",
  "_DEH_AmmoParseLine",
  "_DEH_BEXInclParseLine",
  "_DEH_BEXParsParseLine",
  "_DEH_BEXPtrParseLine",
  "_A_FireOldBFG",
  "_A_RandomJump",
  "_DEH_BEXStrParseLine",
  "_DEH_CheatParseLine",
  "_DEH_FrameParseLine",
  "_DEH_MiscParseLine",
  "_DEH_PointerParseLine",
  "_DEH_SoundParseLine",
  "_DEH_ThingParseLine",
  "_DEH_WeaponParseLine",
  "_I_SDL_UpdateSoundParams",
  "_OPL_Mix_Callback",
  "_mix_channels",
...
var debug_table_viiii = [
  0,
  "__Eff_position_u8",
  "__Eff_position_table_u8",
  "__Eff_position_s8",
  "__Eff_position_table_s8",
  "__Eff_position_u8_c4",
  "__Eff_position_u8_c6",
  "__Eff_position_s8_c4",
  "__Eff_position_s8_c6",
  "__Eff_position_u16lsb",
  "__Eff_position_u16lsb_c4",
  "__Eff_position_u16lsb_c6",
  "__Eff_position_s16lsb",
  "__Eff_position_s16lsb_c4",
  "__Eff_position_s16lsb_c6",
  "__Eff_position_u16msb",
  "__Eff_position_u16msb_c4",
  "__Eff_position_u16msb_c6",
  "__Eff_position_s16msb",
  "__Eff_position_s16msb_c4",
  "__Eff_position_s16msb_c6",
  "__Eff_position_s32msb",
  "__Eff_position_s32msb_c4",
  "__Eff_position_s32msb_c6",
  "__Eff_position_s32lsb",
  "__Eff_position_s32lsb_c4",
  "__Eff_position_s32lsb_c6",
  "__Eff_position_f32sys",
  "__Eff_position_f32sys_c4",
  "__Eff_position_f32sys_c6",
  "_SDL_LogOutput",
  "_Emscripten_SetWindowFullscreen",
  "_Emscripten_GLES_GetDrawableSize",
  "_SDL_JoystickAllowBackgroundEventsChanged",
  "_SDL_GameControllerIgnoreDevicesChanged",
  "_SDL_GameControllerIgnoreDevicesExceptChanged",
  "_SDL_MouseDoubleClickTimeChanged",
  "_SDL_MouseDoubleClickRadiusChanged",
  "_SDL_MouseNormalSpeedScaleChanged",
  "_SDL_MouseRelativeSpeedScaleChanged",
  "_SDL_TouchMouseEventsChanged",
  "_png_set_mem_fn",
  "_png_set_error_fn",
...
function nullFunc_vjii(x) {
  abortFnPtrError(x, "vjii");
}
